...
// required int32 id = 1;
inline bool MyMessage::_internal_has_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool MyMessage::has_id() const {
...
// required string content = 2;
inline bool MyMessage::_internal_has_content() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool MyMessage::has_content() const {
...
inline void MyMessage::set_content(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:MyMessage.content)
}
inline void MyMessage::set_content(const char* value) {
  ...
  content_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:MyMessage.content)
}
inline void MyMessage::set_content(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:MyMessage.content)
}
